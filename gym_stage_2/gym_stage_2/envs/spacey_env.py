...
class FooEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.possible_origin_locations = [[146,429],[432,158],[223,149],[170,439],[259,118],[406,316],[419,191],[389,463],[262,183],[264,305],[205,212],[386,143],[355,482],[383,241],[100,432],[305,315],[128,450],[435,121],[267,183],[405,455],[225,350],[299,362],[283,206],[399,434],[330,151],[168,163],[198,471],[279,380],[208,331],[292,147],[331,199],[241,447],[468,302],[154,229],[339,322],[433,202],[119,334],[138,416],[441,320],[162,150],[128,325],[479,165],[397,228],[223,404],[403,185],[442,348],[158,440],[243,279],[478,225],[445,318]]
        self.possible_target_locations = [[383,349],[252,341],[175,288],[357,275],[225,200],[406,145],[441,332],[496,167],[369,105],[459,299],[114,329],[109,394],[479,126],[246,154],[384,141],[115,215],[206,208],[212,470],[260,115],[214,359],[498,149],[391,440],[177,187],[147,430],[243,449],[349,416],[188,294],[232,385],[342,458],[256,446],[105,421],[131,167],[140,155],[470,448],[399,398],[353,428],[362,180],[231,323],[471,222],[193,307],[265,249],[268,280],[338,191],[100,171],[153,323],[394,488],[183,431],[278,165],[123,217],[207,427]]
        self.inc_test_1 = 0
        self.inc_test_2 = 0
    ...
    def step(self, action):
        ...
        if self.rocket_in_planet_range(position, position_y):
            ...
            if -0.50 <= rocket_orientation_to_planet <= 0.50:
                done = True
                reward = 5
                succeeded = True
            else:
    ...
    def reset(self):
        ...
        self.origin_planet_center= self.possible_origin_locations[self.incre]
        self.target_planet_center = self.possible_target_locations[self.incre]
        self.incre += 1
        self.incre = self.incre % len(self.possible_target_locations)
